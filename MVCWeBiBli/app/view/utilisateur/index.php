...
<div class="wrapper">
    <div class="box">
        <div class="row row-offcanvas row-offcanvas-left">
            ...
            <tr>
                <hr>
                <p> Nom :   <?php echo ($idUtilisateur[0]['NOM_UTILISATEUR']); ?></p> <!--<?php echo $donnees['PRENOM_UTILISATEUR']; ?>-->
            </tr>
            <tr>
               <hr>
               <p> Prénom :  <?php echo ($idUtilisateur[0]['PRENOM_UTILISATEUR']); ?></p> <!--<?php echo $donnees['PRENOM_UTILISATEUR']; ?>-->
            </tr>
            <tr>
                <hr>
                <p> Mail :  <?php echo($idUtilisateur[0]['EMAIL']); ?></p> <!--<?php echo $donnees['PRENOM_UTILISATEUR']; ?>-->
            </tr>
            ...
            <tr>
                ...
                <hr>
                          ...
                          <div class="col-sm-7">
                               ...
                               <div class="panel panel-default">
                                 <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>Inventaire</h4></div>
                                  <div class="panel-body">
