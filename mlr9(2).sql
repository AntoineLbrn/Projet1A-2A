...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 09 mars 2018 à 22:03
...
(21, 'Concert A', 1, '1970-01-01'),
(22, 'Concert A1', 1, '1970-01-01'),
(23, 'Concert A2', 1, '2018-02-16'),
(24, 'Concert A3', 1, '2018-02-22');
...
(77, 1, 2, 'Yo', '2018-03-02', 5),
(78, 1, 2, 'Tu veut ma bite ?', '2018-03-02', 5),
(79, 1, 2, 'non', '2018-03-02', 5),
(80, 1, 2, 'test', '2018-03-02', 5),
(81, 1, 2, 'DSF', '2018-03-02', 5),
(82, 1, 2, 'sdf', '2018-03-02', 5);
...
INSERT INTO `oeuvre` (`ID_OEUVRE`, `NOM`, `DATESORTIE`, `ID_genre`, `EDITEUR`, `URL`, `ID_INSTRUMENT`, `DIFFICULTE`) VALUES
(1, 'Hallelujah', '1970-01-01', 1, '', 'Leonard-Cohen-Hallelujah.pdf', 1, 3),
(2, 'Imagine', '1980-08-07', 1, '', 'imagine.pdf', 0, NULL),
(3, 'La chevauchée des Walkyries', '1970-01-01', 2, '', 'la-chevauchee-des-walkyries.pdf', 0, NULL),
(4, 'Clair de lune', '1970-01-01', 2, '', 'debussyclairdelune.pdf', 0, NULL),
(5, 'Oeuvre de test', '1970-01-01', 3, '', '2017-1-sujet.pdf', 0, 2),
(6, 'azefazefa', '1970-01-01', 2, '', '2017-1-sujet.pdf', 0, NULL),
(7, 'oeuvre trompette', '2019-05-12', 3, '', '2017-1-sujet.pdf', 2, NULL),
(8, 'Oeuvre de test', '1970-01-01', 2, '', '2017-1-sujet.pdf', 6, NULL);
